  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-4 pb-10 md:pb-20">
      ...
      <div className="pointer-events-none absolute inset-x-0 bottom-0 flex justify-center overflow-hidden">
        <div
          className="hidden bg-gradient-to-b from-neutral-500/20 to-neutral-500/0 bg-clip-text text-[10rem] leading-none font-black text-transparent select-none sm:block lg:text-[16rem] dark:from-neutral-400/30"
      ...
      <div className="absolute top-6 right-8 z-20 flex items-center gap-2">
        ...
        <GithubButton
          ...
          label="Star"
          size={'sm'}
          repoUrl="https://github.com/Shiva250503ss/Portfolio-Shivaraj"
        />
      </div>
