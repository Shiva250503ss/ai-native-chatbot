...
const Chat = () => {
  ...
  const submitQuery = (query) => {
    ...
    // Clear previous messages for a clean transition
    setMessages([]);
  ...
  return (
    <div className="relative h-screen overflow-hidden">
      <div className="absolute top-6 right-8 z-51 flex flex-col-reverse items-center justify-center gap-1 md:flex-row">
        ...
        <div className="">
          <GithubButton
            ...
            label="Star"
            size={'sm'}
            repoUrl="https://github.com/Shiva250503ss"
          />
        </div>
      </div>
      ...
      >
        <div
          className={`transition-opacity duration-300 ease-out ${hasActiveTool ? 'pt-6 pb-0' : 'py-6'}`}
        >
          ...
          <AnimatePresence>
            {latestUserMessage && !currentAIMessage && (
              <div
                className="mx-auto flex max-w-3xl px-4 animate-in fade-in duration-200"
              >
        ...
        >
          <AnimatePresence mode="wait">
            {isEmptyState ? (
              <div
                key="landing"
                className="flex min-h-full items-center justify-center animate-in fade-in duration-300"
              >
              ...
              <div
                key="loading"
                className="px-4 pt-18 animate-in fade-in duration-200"
              >
              ...
              <div key={currentAIMessage.id || 'ai-msg'} className="pb-4">
                <SimplifiedChatView
